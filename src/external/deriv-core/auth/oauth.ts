 ...
 * One helper rather than two copies so login can never drift from sign-up —
 * `lang` was added to sign-up's twin in `packages/core` and missed here, which
 * sent a Bot deployed in ES/FR/PT to an English login (#804).
 */
